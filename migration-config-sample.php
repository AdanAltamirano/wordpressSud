<?php
/**
 * Configuration for Joomla to WordPress Migration (SAMPLE)
 * Rename this file to migration-config.php and fill in your details.
 */
...
define('JOOMLA_DB_PASS', ''); // Enter password here
...
define('WP_DB_PASS', ''); // Enter password here
